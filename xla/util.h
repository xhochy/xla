...
// int4 values, and unpacks them so every byte stores one int4 value. 'input'
// should have (num_elements+1)/2 bytes; 'output' should have num_elements
// bytes. The high-order 4-bits in each output are zero.
