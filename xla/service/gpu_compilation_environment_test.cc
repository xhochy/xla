...
TEST(CreateGpuCompilationEnvTest, ValidFlags) {
  Flags flags;
  flags.push_back(std::make_pair("xla_gpu_graph_level", "2"));
...
TEST(CreateGpuCompilationEnvTest, InvalidFlagName) {
  Flags flags;
  flags.push_back(std::make_pair("xla_gpu_invalid_flag", "2"));
...
TEST(CreateGpuCompilationEnvTest, InvalidFlagValue) {
  Flags flags;
  flags.push_back(std::make_pair("xla_gpu_graph_level", "foo"));
