...
TEST_F(GpuConvRewriterTest, SortKeysLessThan) {
...
TEST_F(GpuConvRewriterTest, SortKeysGreaterThan) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, SortKeysGreaterThanSwapped) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, SortPairs) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, SortPairsSwapped) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, NoRewriteManyTensors) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, NoRewriteManyDimensions) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, NoRewriteUnsupportedType) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, NoRewriteComplexComparer) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, NoRewriteMixedKeysValues) {
  constexpr char kHlo[] = R"(
HloModule TestModule
...
TEST_F(GpuConvRewriterTest, NoRewriteSmallSize) {
  constexpr char kHlo[] = R"(
HloModule TestModule
